...
status: executing
stopped_at: Closed quick task 260510-sai (configurable -PemulatorHost + cleartext + 0.0.0.0 bind verified on physical device)
...
Stopped at: Closed quick task 260510-sai (configurable -PemulatorHost + cleartext + 0.0.0.0 bind verified on physical device); next: 260510-v4v + 260510-noi closures, then 260510-pdp expiry verify + Phase 13 web UAT
Resume file: None
