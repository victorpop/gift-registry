...
- [ ] 14-03-firestore-and-storage-rules-deploy-PLAN.md — Deploy firestore.rules + storage.rules (first-time storage deploy with cross-service grant; closes folded todo deploy-phase-12-storage-rules)
