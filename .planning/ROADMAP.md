...
| 16. Android Notifications Inbox + Invite Accept/Decline | 0/6 | Planning complete | - |
...
Plans:
- [ ] 16-01-wave-0-red-tests-and-index-PLAN.md — Wave 1 RED test scaffolding (5 Android + 2 Functions test files), extend rules tests for D-18/D-19, add composite index for inbox cleanup query
