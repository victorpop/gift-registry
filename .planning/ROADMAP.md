...
- [ ] 09-02-PLAN.md -- Wave 1 — ui/common/status/: PulsingDot + StatusChip (dispatcher + Reserved/Given/Open) + PurchasedRowModifier + 7 status string keys (STAT-01..04 RED→GREEN)
...
| 9. Shared Chrome + Status UI | 1/4 | In Progress|  |
