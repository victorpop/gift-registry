...
must_haves:
  truths:
    ...
    - "Email re-reserve UAT item 6 verified end-to-end via a seeded reservation whose Cloud Task release fires in ~60s (D-09, locked path: seed script calls createReservation-equivalent + enqueues a Cloud Task with 60s delay pointing at the deployed releaseReservation onTaskDispatched handler)"
